...
public class SubjectSettingsPromptInputCallback implements CallbackHandler {
    ...
    public boolean supports(String callbackData) {
        return callbackData.startsWith(SubjectSettingsCallbackData.SET_PROMPT);
    }
    ...
    public void handle(Update update) {
        ...
        long specId = Long.parseLong(data.substring(SubjectSettingsCallbackData.SET_PROMPT.length()));
